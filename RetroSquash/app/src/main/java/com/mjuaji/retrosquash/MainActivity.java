    ...
    class SquashCourtView extends SurfaceView implements Runnable {
        ...
        public void updateCourt() {
            ...
            if (ballPosition.y > screenHeight - ballWidth) {
                ...
                //what horizontal direction should we use for next falling ball
                Random randomNumber = new Random();
            ...
            //based on direction of ball update x and y
            if (ballIsMovingDown) {
                ballPosition.y += 6;
            }
            ...
            //reaction of the racket and the ball
        ...
        //for a smooth and consistent frame rate
